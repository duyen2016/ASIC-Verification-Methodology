...
REM
REM Generated by Vivado on Sun May 12 21:59:24 +0700 2024
...
echo "xvlog --incr --relax -prj processor_testbench_vlog.prj"
call xvlog  --incr --relax -prj processor_testbench_vlog.prj -log xvlog.log
