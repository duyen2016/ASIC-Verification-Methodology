...
REM
REM Generated by Vivado on Tue Mar 26 22:22:54 +0700 2024
...
echo "xvlog --incr --relax -prj arbiter_vlog.prj"
call xvlog  --incr --relax -prj arbiter_vlog.prj -log xvlog.log
